...
(async function () {
    ...
    try {
        ...
        if (savedInfo && savedInfo.transactionId) {
            ...
            console.error('No se encontró ID de transacción en localStorage. Redirigiendo a payment.html.');
    ...
    const pollStatus = async () => {
        try {
            ...
            switch (data.status) {
                ...
                case 'error_tc':
                    clearInterval(pollInterval);
                    console.log('Estado "error_tc" detectado. Mostrando alerta y recargando la página.');
